...
const en: Translations = {
  ...
  'spotter.close':                'Close',
  'spotter.subtitle':             'Hold the phone upright with the screen toward you. Turn until the orange dot sits at the top of the dial, then tip the phone until the yellow ring matches. Above the horizon does not mean you can see it by eye.',
...
const tr: Translations = {
  ...
  'spotter.close':                'Kapat',
  'spotter.subtitle':             'Telefonu dik tut, ekran sana baksın. Turuncu nokta dairenin üstüne gelene kadar dön, sarı halka oturana kadar telefonu eğ. Ufukta olmak, gözle göreceğin anlamına gelmez.',
...
const de: Translations = {
  ...
  'spotter.subtitle':             'Telefon aufrecht halten, Display zu dir. Drehen, bis der orangene Punkt oben ist, dann neigen, bis der gelbe Ring passt. Über dem Horizont heißt nicht: mit bloßem Auge sichtbar.',
...
const ru: Translations = {
  ...
  'spotter.subtitle':             'Держи телефон вертикально, экран к себе. Крутись, пока оранжевая точка не сверху, потом наклоняй до жёлтого кольца. Над горизонтом ≠ видно глазом.',
...
const zh: Translations = {
  ...
  'spotter.close':                '关闭',
  'spotter.subtitle':             '竖直握着手机，屏幕朝自己。转到橙色点在圆盘顶部，再倾斜对齐黄环。在地平线以上不等于肉眼能看见。',
