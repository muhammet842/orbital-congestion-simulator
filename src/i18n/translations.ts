...
const en: Translations = {
  ...
  'help.subtitle': 'A quick tour of the main controls. You can reopen this guide anytime with the ? button in the header.',
  'help.got_it': 'Got it',
  'help.step.globe.title': 'Explore the globe',
  'help.step.globe.body': 'Drag to rotate, scroll or pinch to zoom, and click any glowing point to select that object.',
  'help.step.search.title': 'Search and filter',
  'help.step.search.body': 'Use the left panel to search by name, NORAD ID, country, or operator, and filter by orbit layer or object type. On phones, open it with the ☰ button.',
  'help.step.details.title': 'Inspect details',
  'help.step.details.body': 'The right panel shows altitude, velocity, orbit layer, and actions such as orbit trail or ground track. On phones, open it with the ℹ button.',
  'help.step.approaches.title': 'Watch close approaches',
  'help.step.approaches.body': 'The left panel lists predicted close approaches in the next 24 hours. Tap an alert to focus the pair and review the encounter.',
  'help.step.events.title': 'Replay historical events',
  'help.step.events.body': 'Open Historical Events to replay landmark collisions, ASAT tests, docking, and breakups in 3D.',
  'help.step.time.title': 'Control time',
  'help.step.time.body': 'Use the bottom bar to play/pause, scrub ±7 days, jump to Now, stay in LIVE mode, or speed up the simulation.',
  'help.step.projection.title': 'Try a future projection',
  'help.step.projection.body': 'Open Future Projection (🌌) to explore Kessler-style “what if” scenarios by adjusting launch rate, mitigation, and risk.',
...
const tr: Translations = {
  ...
  'help.subtitle': 'Ana kontrollerin kısa turu. Bu rehberi istediğiniz zaman üstteki ? düğmesiyle yeniden açabilirsiniz.',
  'help.got_it': 'Anladım',
  'help.step.globe.title': 'Küreyi keşfedin',
  'help.step.globe.body': 'Döndürmek için sürükleyin, yakınlaştırmak için kaydırın veya kıstırın; bir nesneyi seçmek için parlayan noktaya tıklayın.',
  'help.step.search.title': 'Arayın ve filtreleyin',
  'help.step.search.body': 'Sol panelden isim, NORAD, ülke veya operatörle arayın; yörünge katmanı ve nesne türüne göre filtreleyin. Telefonda ☰ ile açılır.',
  'help.step.details.title': 'Detaylara bakın',
  'help.step.details.body': 'Sağ panel irtifa, hız, yörünge katmanı ve yörünge izi / yer izi gibi eylemleri gösterir. Telefonda ℹ ile açılır.',
  'help.step.approaches.title': 'Yakın geçişleri izleyin',
  'help.step.approaches.body': 'Sol panel önümüzdeki 24 saatteki yakın geçişleri listeler. Bir uyarıya dokunarak çifti odaklayıp karşılaşmayı inceleyin.',
  'help.step.events.title': 'Tarihsel olayları oynatın',
  'help.step.events.body': 'Tarihsel Olaylar’dan dönüm noktası çarpışmaları, ASAT testlerini, kenetlenmeleri ve parçalanmaları 3B olarak yeniden izleyin.',
  'help.step.time.title': 'Zamanı kontrol edin',
  'help.step.time.body': 'Alt çubuktan oynat/duraklat, ±7 gün kaydır, Now’a atla, LIVE’da kal veya simülasyonu hızlandırın.',
  'help.step.projection.title': 'Gelecek projeksiyonunu deneyin',
  'help.step.projection.body': 'Future Projection (🌌) ile fırlatma hızı, mitigasyon ve risk ayarlayarak Kessler tarzı “ne olur” senaryolarını keşfedin.',
...
const de: Translations = {
  ...
  'help.subtitle': 'Kurzer Überblick über die wichtigsten Steuerelemente. Sie können diese Hilfe jederzeit über die ?-Schaltfläche erneut öffnen.',
  'help.got_it': 'Verstanden',
  'help.step.globe.title': 'Den Globus erkunden',
  'help.step.globe.body': 'Ziehen zum Drehen, scrollen oder zoomen, und auf einen leuchtenden Punkt tippen, um ein Objekt zu wählen.',
  'help.step.search.title': 'Suchen und filtern',
  'help.step.search.body': 'Im linken Panel nach Name, NORAD, Land oder Betreiber suchen und nach Orbitlage oder Objekttyp filtern. Auf dem Handy mit ☰ öffnen.',
  'help.step.details.title': 'Details prüfen',
  'help.step.details.body': 'Das rechte Panel zeigt Höhe, Geschwindigkeit, Orbitlage und Aktionen wie Orbitspur oder Bodenspur. Auf dem Handy mit ℹ öffnen.',
  'help.step.approaches.title': 'Nahannäherungen beobachten',
  'help.step.approaches.body': 'Das linke Panel listet vorhergesagte Nahannäherungen der nächsten 24 Stunden. Tippen Sie eine Warnung an, um das Paar zu fokussieren.',
  'help.step.events.title': 'Historische Ereignisse abspielen',
  'help.step.events.body': 'Unter Historische Ereignisse können Sie wichtige Kollisionen, ASAT-Tests, Dockings und Zerfallsereignisse in 3D nachverfolgen.',
  'help.step.time.title': 'Zeit steuern',
  'help.step.time.body': 'In der unteren Leiste: Abspielen/Pause, ±7 Tage scrubben, zu Now springen, LIVE halten oder die Simulation beschleunigen.',
  'help.step.projection.title': 'Zukunftsprojektion ausprobieren',
  'help.step.projection.body': 'Öffnen Sie Future Projection (🌌), um Kessler-Szenarien mit Startquote, Mitigation und Risiko zu erkunden.',
...
const ru: Translations = {
  ...
  'help.subtitle': 'Краткий обзор основных элементов. Снова открыть справку можно кнопкой ? в шапке.',
  'help.got_it': 'Понятно',
  'help.step.globe.title': 'Исследуйте глобус',
  'help.step.globe.body': 'Перетаскивайте для вращения, прокручивайте или сводите пальцы для масштаба, нажмите на точку, чтобы выбрать объект.',
  'help.step.search.title': 'Поиск и фильтры',
  'help.step.search.body': 'В левой панели ищите по имени, NORAD, стране или оператору и фильтруйте по орбите или типу. На телефоне откройте кнопкой ☰.',
  'help.step.details.title': 'Смотрите детали',
  'help.step.details.body': 'Правая панель показывает высоту, скорость, слой орбиты и действия вроде следа орбиты. На телефоне откройте кнопкой ℹ.',
  'help.step.approaches.title': 'Следите за сближениями',
  'help.step.approaches.body': 'В левой панели — прогноз сближений на 24 часа. Нажмите предупреждение, чтобы сфокусировать пару.',
  'help.step.events.title': 'Проигрывайте исторические события',
  'help.step.events.body': 'В разделе исторических событий можно в 3D пересмотреть столкновения, испытания ASAT, стыковки и разрушения.',
  'help.step.time.title': 'Управляйте временем',
  'help.step.time.body': 'Нижняя панель: play/pause, сдвиг ±7 дней, Now, режим LIVE или ускорение симуляции.',
  'help.step.projection.title': 'Попробуйте прогноз будущего',
  'help.step.projection.body': 'Откройте Future Projection (🌌), чтобы менять темп запусков, mitigation и риск в сценариях Кесслера.',
...
const zh: Translations = {
  ...
  'help.close': '关闭',
  'help.title': '如何使用本模拟器',
  'help.subtitle': '主要控件的快速导览。可随时通过顶部的 ? 按钮重新打开本指南。',
  'help.got_it': '知道了',
  'help.step.globe.title': '探索地球',
  'help.step.globe.body': '拖动旋转，滚动或双指缩放，点击发光点即可选中目标。',
  'help.step.search.title': '搜索与筛选',
  'help.step.search.body': '在左侧面板按名称、NORAD、国家或运营方搜索，并按轨道层或目标类型筛选。手机上用 ☰ 打开。',
  'help.step.details.title': '查看详情',
  'help.step.details.body': '右侧面板显示高度、速度、轨道层，以及轨道轨迹/地面轨迹等操作。手机上用 ℹ 打开。',
  'help.step.approaches.title': '关注近距离接近',
  'help.step.approaches.body': '左侧列出未来 24 小时的近距离接近预警。点击预警可聚焦该目标对。',
  'help.step.events.title': '回放历史事件',
  'help.step.events.body': '在历史事件中以 3D 回放标志性碰撞、反卫星试验、对接与解体。',
  'help.step.time.title': '控制时间',
  'help.step.time.body': '底部栏可播放/暂停、在 ±7 天内拖动、跳到 Now、保持 LIVE，或加快模拟速度。',
  'help.step.projection.title': '尝试未来推演',
  'help.step.projection.body': '打开 Future Projection（🌌），调整发射率、缓解措施与风险，探索 Kessler 情景。',
