...
const en: Translations = {
  ...
  // ── Conjunction panel ─────────────────────────────────────────────────
  'conj.empty': 'No crossing-orbit close approaches detected (LEO, 0.1–3 km, relative speed ≥ 50 m/s). Co-orbiting stacks such as ISS or CSS modules are excluded.',
...
const tr: Translations = {
  ...
  'conj.empty': 'Kesişen yörüngeli yakın geçiş tespit edilmedi (AYY, 0.1–3 km, göreli hız ≥ 50 m/s). ISS veya CSS gibi eş yörüngeli modüller hariç tutulmuştur.',
...
const de: Translations = {
  ...
  'conj.empty': 'Keine kreuzenden Nahflüge erkannt (LEO, 0,1–3 km, Relativgeschwindigkeit ≥ 50 m/s). Ko-orbitale Module wie ISS oder CSS sind ausgeschlossen.',
...
const ru: Translations = {
  ...
  'conj.empty': 'Пересекающихся сближений не обнаружено (НОО, 0,1–3 км, скорость ≥ 50 м/с). Совместно орбитальные модули, такие как МКС или CSS, исключены.',
...
const zh: Translations = {
  ...
  'conj.empty': '未检测到交叉轨道近距离接近（低轨道，0.1–3公里，相对速度 ≥ 50米/秒）。国际空间站或CSS等共轨模块已排除。',
