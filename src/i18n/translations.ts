...
const en: Translations = {
  ...
  'help.step.globe.body': 'This is Earth and the tracked objects around it. Drag to rotate, scroll or pinch to zoom, then click a glowing point to select it.',
  ...
  'help.step.approaches.body': 'These alerts list predicted close approaches in the next 24 hours. Tap one to focus that pair on the globe.',
  'help.step.events.title': 'Replay historical events',
  'help.step.events.body': 'Pick a historical event card to replay a landmark collision, ASAT test, docking, or breakup in 3D.',
...
const tr: Translations = {
  ...
  'help.step.globe.body': 'Bu Dünya ve çevresindeki izlenen nesneler. Döndürmek için sürükleyin, yakınlaştırmak için kaydırın veya kıstırın; seçmek için parlayan bir noktaya tıklayın.',
  ...
  'help.step.approaches.body': 'Bu uyarılar önümüzdeki 24 saatteki yakın geçişleri listeler. Birine dokunarak çifti kürede odaklayın.',
  'help.step.events.title': 'Tarihsel olayları oynatın',
  'help.step.events.body': 'Bir tarihsel olay kartı seçerek dönüm noktası çarpışmayı, ASAT testini, kenetlenmeyi veya parçalanmayı 3B olarak yeniden izleyin.',
...
const de: Translations = {
  ...
  'help.step.globe.body': 'Das ist die Erde mit den verfolgten Objekten. Ziehen zum Drehen, scrollen oder zoomen, dann auf einen leuchtenden Punkt tippen.',
  ...
  'help.step.approaches.body': 'Diese Warnungen listen vorhergesagte Nahannäherungen der nächsten 24 Stunden. Tippen Sie eine an, um das Paar zu fokussieren.',
  'help.step.events.title': 'Historische Ereignisse abspielen',
  'help.step.events.body': 'Wählen Sie eine historische Ereigniskarte, um Kollision, ASAT-Test, Docking oder Zerfall in 3D abzuspielen.',
  ...
  'help.step.projection.body': 'Das ist das Future-Projection-Panel. Ändern Sie Startquote, Mitigation und Risiko für Kessler-Szenarien. Erneut öffnen mit 🌌 oben; schließen mit ✕ oder Escape.',
...
const ru: Translations = {
  ...
  'help.step.globe.body': 'Это Земля и отслеживаемые объекты. Перетаскивайте для вращения, масштабируйте, затем нажмите на светящуюся точку.',
  ...
  'help.step.approaches.body': 'Эти предупреждения — прогноз сближений на 24 часа. Нажмите, чтобы сфокусировать пару на глобусе.',
  'help.step.events.title': 'Проигрывайте исторические события',
  'help.step.events.body': 'Выберите карточку события, чтобы в 3D пересмотреть столкновение, испытание ASAT, стыковку или разрушение.',
...
const zh: Translations = {
  ...
  'help.step.globe.body': '这是地球及周围的跟踪目标。拖动旋转，滚动或双指缩放，再点击发光点选中。',
  ...
  'help.step.approaches.body': '这些预警列出未来 24 小时的近距离接近。点按可在地球上聚焦该目标对。',
  'help.step.events.title': '回放历史事件',
  'help.step.events.body': '选择历史事件卡片，以 3D 回放标志性碰撞、反卫星试验、对接或解体。',
