...
const en: Translations = {
  ...
  'ui.recent_launches_hint': 'First seen in our TLE list in the last 14 days — not the launch date',
  'badge.new_launch':     'NEW',
  'badge.new_launch_title': 'New to this app’s TLE catalog (last 14 days). Not the physical launch date.',
  ...
  'spotter.close':                'Close',
  'spotter.subtitle':             'Point your phone like a compass. Turn until the amber marker is at the top, then look up to the elevation. Above horizon ≠ naked-eye visible.',
...
const tr: Translations = {
  ...
  'ui.recent_launches_hint': 'Son 14 günde TLE listemize ilk kez girenler — fırlatma tarihi değil',
  'badge.new_launch':     'YENİ',
  'badge.new_launch_title': 'Bu uygulamanın TLE kataloğuna son 14 günde ilk kez girdi. Fırlatma tarihi değildir.',
...
const de: Translations = {
  ...
  'ui.recent_launches_hint': 'Erstmals in unserer TLE-Liste in den letzten 14 Tagen — nicht das Startdatum',
  'badge.new_launch':     'NEU',
  'badge.new_launch_title': 'Neu in diesem TLE-Katalog (letzte 14 Tage). Nicht das physische Startdatum.',
  ...
  'spotter.subtitle':             'Halten Sie das Telefon wie einen Kompass. Drehen Sie, bis die bernsteinfarbene Markierung oben ist, dann schauen Sie zur Elevation hoch. Über dem Horizont ≠ mit bloßem Auge sichtbar.',
...
const ru: Translations = {
  ...
  'ui.recent_launches_hint': 'Впервые в нашем TLE-списке за 14 дней — не дата запуска',
  'badge.new_launch':     'НОВ',
  'badge.new_launch_title': 'Впервые в TLE-каталоге приложения за 14 дней. Это не дата запуска.',
...
const zh: Translations = {
  ...
  'ui.recent_launches_hint': '最近14天首次进入我们的 TLE 列表 — 不是发射日期',
  'badge.new_launch':     '新',
  'badge.new_launch_title': '最近14天首次进入本应用的 TLE 目录。不是实际发射日期。',
