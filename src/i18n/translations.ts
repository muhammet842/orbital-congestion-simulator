...
const en: Translations = {
  ...
  'spotter.close':                'Close',
  'spotter.subtitle':             'Hold the phone upright (screen toward you). Turn until the amber marker is at the top, then tilt so the yellow ring matches. Wave the phone in a figure-8 if the compass feels stuck. Above horizon ≠ naked-eye visible.',
  'spotter.compass_hint':         'Top = facing · yellow ring = phone tilt · amber = target',
  'spotter.hold_hint':            'Hold upright, screen toward you. If turns feel wrong: outdoors, wave a figure-8, enable compass, wait for live GPS.',
  ...
  'spotter.compass_calibrate':    'No absolute compass — wave phone in a figure-8 outdoors, then retry',
  ...
  'spotter.cue_locked_eclipse':   'On target · satellite in shadow',
  ...
  'spotter.chip_eye_eclipse':     'Sat in shadow',
  'spotter.chip_gps':             'GPS',
  'spotter.chip_gps_weak':        'Weak GPS',
  'spotter.chip_loc_cached':      'Cached location',
  'spotter.chip_compass':         'Compass',
  'spotter.chip_compass_off':     'Compass off',
  ...
  'spotter.photo_eclipse_short':  'Satellite in Earth shadow (no sunlight) — usually invisible',
...
const tr: Translations = {
  ...
  'spotter.close':                'Kapat',
  'spotter.subtitle':             'Telefonu dik tutun (ekran size bakacak). Camgöbeği işaret üste gelene kadar dönün, sarı halka hedef elevasyonuna gelene kadar eğin. Pusula takılırsa dışarıda 8 çizerek kalibre edin. Ufuk üstünde olmak çıplak gözle görünür demek değildir.',
  'spotter.compass_hint':         'Üst = yön · sarı halka = telefon eğimi · camgöbeği = hedef',
  'spotter.hold_hint':            'Dik tutun, ekran size baksın. Dönüşler yanlışsa: dışarıda 8 çizin, pusulayı açın, canlı GPS bekleyin.',
  ...
  'spotter.compass_calibrate':    'Mutlak pusula yok — dışarıda telefona 8 çizdirip yeniden deneyin',
  ...
  'spotter.cue_locked_eclipse':   'Hedefte · uydu gölgede',
...
const de: Translations = {
  ...
  'spotter.subtitle':             'Telefon aufrecht halten (Display zu Ihnen). Drehen bis die Markierung oben ist, dann neigen bis der gelbe Ring passt. Bei klemmendem Kompass draußen eine Acht schwenken. Über dem Horizont ≠ mit bloßem Auge sichtbar.',
  'spotter.compass_hint':         'Oben = Blick · gelber Ring = Neigung · Cyan = Ziel',
  'spotter.hold_hint':            'Aufrecht halten, Display zu Ihnen. Falsche Drehungen: draußen Acht schwenken, Kompass an, auf Live-GPS warten.',
  ...
  'spotter.compass_calibrate':    'Kein absoluter Kompass — draußen eine Acht schwenken und erneut versuchen',
  'spotter.loc_gps':              'GPS live',
  ...
  'spotter.cue_locked_eclipse':   'Im Ziel · Satellit im Schatten',
  ...
  'spotter.photo_eclipse_short':  'Satellit im Erdschatten (kein Sonnenlicht) — meist unsichtbar',
...
const ru: Translations = {
  ...
  'spotter.subtitle':             'Держите телефон вертикально (экран к себе). Поворачивайтесь, пока метка не сверху, затем наклоняйте до совпадения жёлтого кольца. Если компас «залип» — опишите восьмёрку на улице. Над горизонтом ≠ видно невооружённым глазом.',
  'spotter.compass_hint':         'Верх = взгляд · жёлтое кольцо = наклон · бирюза = цель',
  'spotter.hold_hint':            'Держите вертикально, экран к себе. Если повороты неверны: на улице восьмёрка, включите компас, дождитесь GPS.',
  ...
  'spotter.compass_calibrate':    'Нет абсолютного компаса — на улице опишите восьмёрку телефоном и повторите',
  ...
  'spotter.cue_locked_eclipse':   'В прицеле · спутник в тени',
...
const zh: Translations = {
  ...
  'spotter.close':                '关闭',
  'spotter.subtitle':             '竖直握持手机（屏幕朝向自己）。转动直到标记在顶部，再倾斜使黄环对齐。指南针卡住时到户外画“8”字校准。在地平线以上 ≠ 肉眼可见。',
  'spotter.compass_hint':         '顶部=朝向 · 黄环=手机倾角 · 青色=目标',
  'spotter.hold_hint':            '竖直握持、屏幕朝自己。转向不准时：户外画“8”字、启用指南针、等待实时 GPS。',
  'spotter.location':             '位置',
  'spotter.heading':              '指南针',
  'spotter.lat':                  '纬度',
  'spotter.lon':                  '经度',
  ...
  'spotter.compass_calibrate':    '无绝对指南针 — 到户外画“8”字校准后再试',
  ...
  'spotter.cue_locked_eclipse':   '已对准 · 卫星在阴影中',
  ...
  'spotter.photo_eclipse_short':  '卫星在地球阴影中（无阳光）— 通常不可见',
