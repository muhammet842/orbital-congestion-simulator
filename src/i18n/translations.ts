...
const en: Translations = {
  ...
  'conj.filter_time_label': 'Time window',
  'conj.filter_risk_label': 'Risk',
  'conj.filter_horizon':    '{h}h',
  'conj.filter_risk_all':   'All',
  'conj.filter_risk_critical': 'Critical',
  'conj.filter_risk_monitoring': 'Monitoring+',
  'conj.filter_empty':      'No close approaches match these filters.',
...
const tr: Translations = {
  ...
  'conj.filter_time_label': 'Zaman penceresi',
  'conj.filter_risk_label': 'Risk',
  'conj.filter_horizon':    '{h}sa',
  'conj.filter_risk_all':   'Tümü',
  'conj.filter_risk_critical': 'Kritik',
  'conj.filter_risk_monitoring': 'İzleme+',
  'conj.filter_empty':      'Bu filtrelere uyan yakın geçiş yok.',
...
const de: Translations = {
  ...
  'conj.filter_time_label': 'Zeitfenster',
  'conj.filter_risk_label': 'Risiko',
  'conj.filter_horizon':    '{h}h',
  'conj.filter_risk_all':   'Alle',
  'conj.filter_risk_critical': 'Kritisch',
  'conj.filter_risk_monitoring': 'Überwachung+',
  'conj.filter_empty':      'Keine Nahflüge passen zu diesen Filtern.',
...
const ru: Translations = {
  ...
  'conj.filter_time_label': 'Окно времени',
  'conj.filter_risk_label': 'Риск',
  'conj.filter_horizon':    '{h}ч',
  'conj.filter_risk_all':   'Все',
  'conj.filter_risk_critical': 'Критический',
  'conj.filter_risk_monitoring': 'Мониторинг+',
  'conj.filter_empty':      'Нет сближений по этим фильтрам.',
...
const zh: Translations = {
  ...
  'conj.filter_time_label': '时间窗口',
  'conj.filter_risk_label': '风险',
  'conj.filter_horizon':    '{h}小时',
  'conj.filter_risk_all':   '全部',
  'conj.filter_risk_critical': '危急',
  'conj.filter_risk_monitoring': '监测+',
  'conj.filter_empty':      '没有符合这些筛选条件的近距离接近。',
