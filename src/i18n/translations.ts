...
const en: Translations = {
  ...
  'spotter.close':                'Close',
  'spotter.subtitle':             'Point your phone like a compass. Turn until the cyan marker is at the top, then look up to the elevation.',
  ...
  'spotter.guide_locked':         'On target · elev {el}° · {range} km — shoot!',
  ...
  'spotter.photo_good':           'Photo tip: satellite lit, sky dark — good catch window.',
  'spotter.photo_eclipse':        'Photo tip: object may be in Earth shadow (dim or invisible).',
  'spotter.photo_daytime':        'Photo tip: daytime sky — hard to see except the brightest objects.',
...
const tr: Translations = {
  ...
  'spotter.close':                'Kapat',
  'spotter.subtitle':             'Telefonu pusula gibi tutun. Camgöbeği işaret üste gelene kadar dönün, sonra elevasyon kadar yukarı bakın.',
  ...
  'spotter.guide_locked':         'Hedefte · yükseklik {el}° · {range} km — çek!',
  ...
  'spotter.photo_good':           'Foto ipucu: uydu aydınlık, gökyüzü karanlık — iyi yakalama penceresi.',
  'spotter.photo_eclipse':        'Foto ipucu: nesne Dünya gölgesinde olabilir (sönük / görünmez).',
  'spotter.photo_daytime':        'Foto ipucu: gündüz gökyüzü — yalnızca en parlak nesneler görünür.',
...
const de: Translations = {
  ...
  'spotter.subtitle':             'Halten Sie das Telefon wie einen Kompass. Drehen Sie, bis die cyan Markierung oben ist, dann schauen Sie zur Elevation hoch.',
  ...
  'spotter.guide_locked':         'Im Ziel · Elev {el}° · {range} km — aufnehmen!',
  ...
  'spotter.photo_good':           'Foto-Tipp: Satellit beleuchtet, Himmel dunkel — gutes Zeitfenster.',
  'spotter.photo_eclipse':        'Foto-Tipp: Objekt möglicherweise im Erdschatten (schwach/unsichtbar).',
  'spotter.photo_daytime':        'Foto-Tipp: Taghimmel — nur hellste Objekte sichtbar.',
...
const ru: Translations = {
  ...
  'spotter.subtitle':             'Держите телефон как компас. Поворачивайтесь, пока бирюзовая метка не окажется сверху, затем смотрите вверх на угол места.',
  ...
  'spotter.guide_locked':         'В прицеле · высота {el}° · {range} км — снимайте!',
  ...
  'spotter.photo_good':           'Совет: спутник освещён, небо тёмное — хорошее окно для съёмки.',
  'spotter.photo_eclipse':        'Совет: объект может быть в тени Земли (тусклый/невидимый).',
  'spotter.photo_daytime':        'Совет: дневное небо — видны только самые яркие объекты.',
...
const zh: Translations = {
  ...
  'spotter.title':                '实时瞄准',
  'spotter.close':                '关闭',
  'spotter.subtitle':             '像指南针一样握住手机。转动直到青色标记位于顶部，再按仰角抬头观看。',
  ...
  'spotter.guide_locked':         '已对准 · 仰角 {el}° · {range} km — 拍摄！',
  ...
  'spotter.photo_good':           '拍摄提示：卫星被照亮、天空较暗 — 适合抓拍。',
  'spotter.photo_eclipse':        '拍摄提示：目标可能在地球阴影中（较暗/不可见）。',
  'spotter.photo_daytime':        '拍摄提示：白天天空 — 仅最亮目标可见。',
