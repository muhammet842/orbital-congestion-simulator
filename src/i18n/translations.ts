...
const en: Translations = {
  ...
  'spotter.compass_hint':         'Top of dial = direction you are facing',
  ...
  'spotter.below_rise':           'Below horizon · rises ~{time} toward az {az}°',
  'spotter.below_none':           'Below horizon · no rise in the next ~6 hours',
  'spotter.guide_no_compass':     'Look az {az}° · elev {el}° · {range} km',
  'spotter.guide_locked':         'On target · elev {el}° · {range} km — good catch window!',
  'spotter.guide_aimed_day':      'Aimed OK · elev {el}° · {range} km — daytime: unlikely naked-eye',
  'spotter.guide_aimed_eclipse':  'Aimed OK · elev {el}° · {range} km — in Earth shadow: likely invisible',
  'spotter.guide_aimed_dim':      'Aimed OK · elev {el}° · {range} km — geometry OK, optically uncertain',
  'spotter.guide_look_up':        'Facing OK · look up {el}° · {range} km',
  'spotter.guide_right':          'Turn right {deg}° · elev {el}° · {range} km',
  'spotter.guide_left':           'Turn left {deg}° · elev {el}° · {range} km',
...
const tr: Translations = {
  ...
  'spotter.compass_hint':         'Kadranın üstü = baktığınız yön',
  ...
  'spotter.below_rise':           'Ufuk altında · ~{time} civarı doğuş, azimut {az}°',
  'spotter.below_none':           'Ufuk altında · sonraki ~6 saatte doğuş yok',
  'spotter.guide_no_compass':     'Azimut {az}° · yükseklik {el}° · {range} km',
  'spotter.guide_locked':         'Hedefte · yükseklik {el}° · {range} km — iyi yakalama penceresi!',
  'spotter.guide_aimed_day':      'Yön tamam · yükseklik {el}° · {range} km — gündüz: çıplak gözle zor',
  'spotter.guide_aimed_eclipse':  'Yön tamam · yükseklik {el}° · {range} km — Dünya gölgesinde: muhtemelen görünmez',
  'spotter.guide_aimed_dim':      'Yön tamam · yükseklik {el}° · {range} km — geometri tamam, optik belirsiz',
  'spotter.guide_look_up':        'Yön tamam · {el}° yukarı bak · {range} km',
  'spotter.guide_right':          'Sağa {deg}° dön · yükseklik {el}° · {range} km',
  'spotter.guide_left':           'Sola {deg}° dön · yükseklik {el}° · {range} km',
...
const de: Translations = {
  ...
  'spotter.compass_hint':         'Oberseite der Scheibe = Blickrichtung',
  ...
  'spotter.below_rise':           'Unter Horizont · Aufgang ~{time} bei Azimut {az}°',
  'spotter.below_none':           'Unter Horizont · kein Aufgang in ~6 Stunden',
  'spotter.guide_no_compass':     'Azimut {az}° · Elev {el}° · {range} km',
  'spotter.guide_locked':         'Im Ziel · Elev {el}° · {range} km — gutes Zeitfenster!',
  'spotter.guide_aimed_day':      'Ausgerichtet · Elev {el}° · {range} km — tagsüber: kaum mit bloßem Auge',
  'spotter.guide_aimed_eclipse':  'Ausgerichtet · Elev {el}° · {range} km — im Erdschatten: meist unsichtbar',
  'spotter.guide_aimed_dim':      'Ausgerichtet · Elev {el}° · {range} km — Geometrie OK, optisch unsicher',
  'spotter.guide_look_up':        'Richtung OK · {el}° nach oben · {range} km',
  'spotter.guide_right':          'Rechts {deg}° drehen · Elev {el}° · {range} km',
  'spotter.guide_left':           'Links {deg}° drehen · Elev {el}° · {range} km',
...
const ru: Translations = {
  ...
  'spotter.compass_hint':         'Верх диска = направление взгляда',
  ...
  'spotter.below_rise':           'Ниже горизонта · восход ~{time}, азимут {az}°',
  'spotter.below_none':           'Ниже горизонта · нет восхода в ближайшие ~6 ч',
  'spotter.guide_no_compass':     'Азимут {az}° · высота {el}° · {range} км',
  'spotter.guide_locked':         'В прицеле · высота {el}° · {range} км — хорошее окно!',
  'spotter.guide_aimed_day':      'Направление ОК · высота {el}° · {range} км — днём: вряд ли видно невооружённым глазом',
  'spotter.guide_aimed_eclipse':  'Направление ОК · высота {el}° · {range} км — в тени Земли: скорее невидимо',
  'spotter.guide_aimed_dim':      'Направление ОК · высота {el}° · {range} км — геометрия ок, оптика неясна',
  'spotter.guide_look_up':        'Направление ОК · смотрите вверх {el}° · {range} км',
  'spotter.guide_right':          'Вправо на {deg}° · высота {el}° · {range} км',
  'spotter.guide_left':           'Влево на {deg}° · высота {el}° · {range} км',
...
const zh: Translations = {
  ...
  'spotter.compass_hint':         '表盘顶部 = 你面对的方向',
  'spotter.location':             '位置',
  'spotter.heading':              '指南针',
  'spotter.lat':                  '纬度',
  'spotter.lon':                  '经度',
  ...
  'spotter.below_rise':           '地平线以下 · 约 {time} 升起，方位角 {az}°',
  'spotter.below_none':           '地平线以下 · 未来约 6 小时内无升起',
  'spotter.guide_no_compass':     '方位 {az}° · 仰角 {el}° · {range} km',
  'spotter.guide_locked':         '已对准 · 仰角 {el}° · {range} km — 适合观测/拍摄！',
  'spotter.guide_aimed_day':      '方向正确 · 仰角 {el}° · {range} km — 白天：肉眼几乎看不见',
  'spotter.guide_aimed_eclipse':  '方向正确 · 仰角 {el}° · {range} km — 地球阴影中：通常不可见',
  'spotter.guide_aimed_dim':      '方向正确 · 仰角 {el}° · {range} km — 几何正确，光学不确定',
  'spotter.guide_look_up':        '方向正确 · 抬头 {el}° · {range} km',
  'spotter.guide_right':          '向右转 {deg}° · 仰角 {el}° · {range} km',
  'spotter.guide_left':           '向左转 {deg}° · 仰角 {el}° · {range} km',
