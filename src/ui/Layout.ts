  ...
  root.innerHTML = `
    <div class="app-grid">
      <header class="app-header">
        <button id="toggle-left-panel" class="panel-toggle-btn" type="button" aria-label="Toggle filters panel" aria-expanded="false">☰</button>
        ...
        <button id="toggle-right-panel" class="panel-toggle-btn" type="button" aria-label="Toggle details panel" aria-expanded="false">ℹ</button>
