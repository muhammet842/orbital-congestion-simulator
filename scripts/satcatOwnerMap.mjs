export const SATCAT_OWNER_MAP = {
  ...
  AB: { country: 'International', owner: 'Arab Satellite Communications Organization' },
  ABS: { country: 'International', owner: 'Asia Broadcast Satellite' },
  AC: { country: 'International', owner: 'Asia Satellite Telecommunications Company (ASIASAT)' },
  ...
  EUME: { country: 'Europe 🇪🇺', owner: 'EUMETSAT' },
  EUTE: { country: 'Europe 🇪🇺', owner: 'EUTELSAT' },
  ...
  IM: { country: 'International', owner: 'INMARSAT' },
  IRID: { country: 'USA 🇺🇸', owner: 'Iridium' },
  ISRO: { country: 'India 🇮🇳', owner: 'ISRO' },
  ISS: { country: 'International', owner: 'International Space Station' },
  ITSO: { country: 'International', owner: 'INTELSAT' },
  NATO: { country: 'International', owner: 'NATO' },
  NICO: { country: 'International', owner: 'New ICO' },
  O3B: { country: 'Luxembourg 🇱🇺', owner: 'O3b Networks' },
  ORB: { country: 'USA 🇺🇸', owner: 'ORBCOMM' },
  PRES: { country: 'International', owner: 'China / ESA' },
